...
export async function getServerPageGetConteudoSetor
    (options: Omit<Apollo.QueryOptions<Types.GetConteudoSetorQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
        
        const data = await apolloClient.query<Types.GetConteudoSetorQuery>({ ...options, query: Operations.GetConteudoSetorDocument });
...
export const useGetConteudoSetor = (
  optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetConteudoSetorQuery, Types.GetConteudoSetorQueryVariables>) => {
  const router = useRouter();
  const options = optionsFunc ? optionsFunc(router) : {};
  return useQuery(Operations.GetConteudoSetorDocument, options);
};
export type PageGetConteudoSetorComp = React.FC<{data?: Types.GetConteudoSetorQuery, error?: Apollo.ApolloError}>;
export const withPageGetConteudoSetor = (optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetConteudoSetorQuery, Types.GetConteudoSetorQueryVariables>) => (WrappedComponent:PageGetConteudoSetorComp) : NextPage  => (props) => {
                const router = useRouter()
                const options = optionsFunc ? optionsFunc(router) : {};
                const {data, error } = useQuery(Operations.GetConteudoSetorDocument, options)    
                return <WrappedComponent {...props} data={data} error={error} /> ;
                   
            }; 
export const ssrGetConteudoSetor = {
      getServerPage: getServerPageGetConteudoSetor,
      withPage: withPageGetConteudoSetor,
      usePage: useGetConteudoSetor,
    }
...
export async function getServerPageGetLinhas
    (options: Omit<Apollo.QueryOptions<Types.GetLinhasQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
        
        const data = await apolloClient.query<Types.GetLinhasQuery>({ ...options, query: Operations.GetLinhasDocument });
...
export const useGetLinhas = (
  optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetLinhasQuery, Types.GetLinhasQueryVariables>) => {
  const router = useRouter();
  const options = optionsFunc ? optionsFunc(router) : {};
  return useQuery(Operations.GetLinhasDocument, options);
};
export type PageGetLinhasComp = React.FC<{data?: Types.GetLinhasQuery, error?: Apollo.ApolloError}>;
export const withPageGetLinhas = (optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetLinhasQuery, Types.GetLinhasQueryVariables>) => (WrappedComponent:PageGetLinhasComp) : NextPage  => (props) => {
                const router = useRouter()
                const options = optionsFunc ? optionsFunc(router) : {};
                const {data, error } = useQuery(Operations.GetLinhasDocument, options)    
                return <WrappedComponent {...props} data={data} error={error} /> ;
                   
            }; 
export const ssrGetLinhas = {
      getServerPage: getServerPageGetLinhas,
      withPage: withPageGetLinhas,
      usePage: useGetLinhas,
    }
export async function getServerPageGetNoticiasBySlug
    (options: Omit<Apollo.QueryOptions<Types.GetNoticiasBySlugQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
        
        const data = await apolloClient.query<Types.GetNoticiasBySlugQuery>({ ...options, query: Operations.GetNoticiasBySlugDocument });
...
export const useGetNoticiasBySlug = (
  optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetNoticiasBySlugQuery, Types.GetNoticiasBySlugQueryVariables>) => {
  const router = useRouter();
  const options = optionsFunc ? optionsFunc(router) : {};
  return useQuery(Operations.GetNoticiasBySlugDocument, options);
};
export type PageGetNoticiasBySlugComp = React.FC<{data?: Types.GetNoticiasBySlugQuery, error?: Apollo.ApolloError}>;
export const withPageGetNoticiasBySlug = (optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetNoticiasBySlugQuery, Types.GetNoticiasBySlugQueryVariables>) => (WrappedComponent:PageGetNoticiasBySlugComp) : NextPage  => (props) => {
                const router = useRouter()
                const options = optionsFunc ? optionsFunc(router) : {};
                const {data, error } = useQuery(Operations.GetNoticiasBySlugDocument, options)    
                return <WrappedComponent {...props} data={data} error={error} /> ;
                   
            }; 
export const ssrGetNoticiasBySlug = {
      getServerPage: getServerPageGetNoticiasBySlug,
      withPage: withPageGetNoticiasBySlug,
      usePage: useGetNoticiasBySlug,
    }
...
export async function getServerPageGetListaNoticias
    (options: Omit<Apollo.QueryOptions<Types.GetListaNoticiasQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
        
        const data = await apolloClient.query<Types.GetListaNoticiasQuery>({ ...options, query: Operations.GetListaNoticiasDocument });
...
export const useGetListaNoticias = (
  optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetListaNoticiasQuery, Types.GetListaNoticiasQueryVariables>) => {
  const router = useRouter();
  const options = optionsFunc ? optionsFunc(router) : {};
  return useQuery(Operations.GetListaNoticiasDocument, options);
};
export type PageGetListaNoticiasComp = React.FC<{data?: Types.GetListaNoticiasQuery, error?: Apollo.ApolloError}>;
export const withPageGetListaNoticias = (optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetListaNoticiasQuery, Types.GetListaNoticiasQueryVariables>) => (WrappedComponent:PageGetListaNoticiasComp) : NextPage  => (props) => {
                const router = useRouter()
                const options = optionsFunc ? optionsFunc(router) : {};
                const {data, error } = useQuery(Operations.GetListaNoticiasDocument, options)    
                return <WrappedComponent {...props} data={data} error={error} /> ;
                   
            }; 
export const ssrGetListaNoticias = {
      getServerPage: getServerPageGetListaNoticias,
      withPage: withPageGetListaNoticias,
      usePage: useGetListaNoticias,
    }
export async function getServerPageGetDestaques
    (options: Omit<Apollo.QueryOptions<Types.GetDestaquesQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
        
        const data = await apolloClient.query<Types.GetDestaquesQuery>({ ...options, query: Operations.GetDestaquesDocument });
...
export const useGetDestaques = (
  optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetDestaquesQuery, Types.GetDestaquesQueryVariables>) => {
  const router = useRouter();
  const options = optionsFunc ? optionsFunc(router) : {};
  return useQuery(Operations.GetDestaquesDocument, options);
};
export type PageGetDestaquesComp = React.FC<{data?: Types.GetDestaquesQuery, error?: Apollo.ApolloError}>;
export const withPageGetDestaques = (optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetDestaquesQuery, Types.GetDestaquesQueryVariables>) => (WrappedComponent:PageGetDestaquesComp) : NextPage  => (props) => {
                const router = useRouter()
                const options = optionsFunc ? optionsFunc(router) : {};
                const {data, error } = useQuery(Operations.GetDestaquesDocument, options)    
                return <WrappedComponent {...props} data={data} error={error} /> ;
                   
            }; 
export const ssrGetDestaques = {
      getServerPage: getServerPageGetDestaques,
      withPage: withPageGetDestaques,
      usePage: useGetDestaques,
    }
export async function getServerPageGetPesquisasDeSatisfacao
    (options: Omit<Apollo.QueryOptions<Types.GetPesquisasDeSatisfacaoQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
        
        const data = await apolloClient.query<Types.GetPesquisasDeSatisfacaoQuery>({ ...options, query: Operations.GetPesquisasDeSatisfacaoDocument });
...
export const useGetPesquisasDeSatisfacao = (
  optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetPesquisasDeSatisfacaoQuery, Types.GetPesquisasDeSatisfacaoQueryVariables>) => {
  const router = useRouter();
  const options = optionsFunc ? optionsFunc(router) : {};
  return useQuery(Operations.GetPesquisasDeSatisfacaoDocument, options);
};
export type PageGetPesquisasDeSatisfacaoComp = React.FC<{data?: Types.GetPesquisasDeSatisfacaoQuery, error?: Apollo.ApolloError}>;
export const withPageGetPesquisasDeSatisfacao = (optionsFunc?: (router: NextRouter)=> QueryHookOptions<Types.GetPesquisasDeSatisfacaoQuery, Types.GetPesquisasDeSatisfacaoQueryVariables>) => (WrappedComponent:PageGetPesquisasDeSatisfacaoComp) : NextPage  => (props) => {
                const router = useRouter()
                const options = optionsFunc ? optionsFunc(router) : {};
                const {data, error } = useQuery(Operations.GetPesquisasDeSatisfacaoDocument, options)    
                return <WrappedComponent {...props} data={data} error={error} /> ;
                   
            }; 
export const ssrGetPesquisasDeSatisfacao = {
      getServerPage: getServerPageGetPesquisasDeSatisfacao,
      withPage: withPageGetPesquisasDeSatisfacao,
      usePage: useGetPesquisasDeSatisfacao,
    }
