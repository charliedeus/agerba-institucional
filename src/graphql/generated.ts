...
export type ComponentConcessaoConcessao = {
  ...
  id: Scalars['ID']
  localizacao_das_bases_do_servico_de_apoio_ao_usuario?: Maybe<
    Array<Maybe<UploadFile>>
  >
...
export type ComponentConcessaoConcessaoInput = {
  Base_de_servico_de_apoio_ao_usuario?: InputMaybe<
  ...
  data_da_assinatura: Scalars['Date']
  localizacao_das_bases_do_servico_de_apoio_ao_usuario?: InputMaybe<
    Array<InputMaybe<Scalars['ID']>>
  >
...
export type ComponentEditalEditalInput = {
  ...
  assinatura: Scalars['Date']
  contrato: Scalars['String']
  programa_de_exploracao_de_rodovias?: InputMaybe<
    Array<InputMaybe<Scalars['ID']>>
  >
}
...
export type CsjriInformeDeJulgamentoGroupBy = {
  ...
  Description?: Maybe<
    Array<Maybe<CsjriInformeDeJulgamentoConnectionDescription>>
  >
  ...
  published_at?: Maybe<
    Array<Maybe<CsjriInformeDeJulgamentoConnectionPublished_At>>
  >
...
export type DtafTarifasDosTerminaisHidroviarioInput = {
  ...
  Terminais_Hidroviarios?: InputMaybe<
    Array<InputMaybe<ComponentTerminaisHidroviariosTerminaisHidroviarioInput>>
  >
  created_by?: InputMaybe<Scalars['ID']>
  published_at?: InputMaybe<Scalars['DateTime']>
  updated_by?: InputMaybe<Scalars['ID']>
...
export type DtafTarifasDosTerminaisHidroviarios = {
  ...
  Terminais_Hidroviarios?: Maybe<
    Array<Maybe<ComponentTerminaisHidroviariosTerminaisHidroviarios>>
  >
  created_at: Scalars['DateTime']
  id: Scalars['ID']
  published_at?: Maybe<Scalars['DateTime']>
...
export type DtafTarifasDosTerminaisHidroviariosGroupBy = {
  ...
  Classe_I?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionClasse_I>>
  >
  Classe_II?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionClasse_Ii>>
  >
  Classe_III?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionClasse_Iii>>
  >
  Classe_IV?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionClasse_Iv>>
  >
  Obs_Classe_I?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_I>>
  >
  Obs_Classe_II?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_Ii>>
  >
  Obs_Classe_III?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_Iii>>
  >
  Obs_Classe_IV?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_Iv>>
  >
  created_at?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionCreated_At>>
  >
  id?: Maybe<Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionId>>>
  published_at?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionPublished_At>>
  >
  updated_at?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviariosConnectionUpdated_At>>
  >
}
...
export type Morph =
  | AscomCartilhas
  | AscomCartilhasAggregator
  | AscomCartilhasConnection
  | AscomCartilhasConnectionAno
  | AscomCartilhasConnectionCartilha
  | AscomCartilhasConnectionCreated_At
  | AscomCartilhasConnectionId
  | AscomCartilhasConnectionPublished_At
  | AscomCartilhasConnectionTitulo
  | AscomCartilhasConnectionUpdated_At
  | AscomCartilhasGroupBy
  | AscomFaq
  | AscomFaqAggregator
  | AscomFaqConnection
  | AscomFaqConnectionCreated_At
  | AscomFaqConnectionId
  | AscomFaqConnectionPergunta
  | AscomFaqConnectionPublished_At
  | AscomFaqConnectionResposta
  | AscomFaqConnectionUpdated_At
  | AscomFaqGroupBy
  | AtasDeColegiado
  | AtasDeColegiadoAggregator
  | AtasDeColegiadoConnection
  | AtasDeColegiadoConnectionCreated_At
  | AtasDeColegiadoConnectionData
  | AtasDeColegiadoConnectionDescritption
  | AtasDeColegiadoConnectionId
  | AtasDeColegiadoConnectionPublished_At
  | AtasDeColegiadoConnectionTeste
  | AtasDeColegiadoConnectionTitulo
  | AtasDeColegiadoConnectionUpdated_At
  | AtasDeColegiadoGroupBy
  | AtasDeJulgamento
  | AtasDeJulgamentoAggregator
  | AtasDeJulgamentoConnection
  | AtasDeJulgamentoConnectionCreated_At
  | AtasDeJulgamentoConnectionData
  | AtasDeJulgamentoConnectionDescription
  | AtasDeJulgamentoConnectionId
  | AtasDeJulgamentoConnectionPublished_At
  | AtasDeJulgamentoConnectionTitulo
  | AtasDeJulgamentoConnectionUpdated_At
  | AtasDeJulgamentoGroupBy
  | AudienciasPublicas
  | AudienciasPublicasAggregator
  | AudienciasPublicasConnection
  | AudienciasPublicasConnectionComunica
  | AudienciasPublicasConnectionCreated_At
  | AudienciasPublicasConnectionData
  | AudienciasPublicasConnectionEncerramento
  | AudienciasPublicasConnectionId
  | AudienciasPublicasConnectionLocal
  | AudienciasPublicasConnectionParticipacao
  | AudienciasPublicasConnectionPublished_At
  | AudienciasPublicasConnectionTitulo
  | AudienciasPublicasConnectionUpdated_At
  | AudienciasPublicasGroupBy
  | ComapContratosCovid
  | ComapContratosCovidAggregator
  | ComapContratosCovidConnection
  | ComapContratosCovidConnectionCreated_At
  | ComapContratosCovidConnectionId
  | ComapContratosCovidConnectionPreambulo
  | ComapContratosCovidConnectionPublished_At
  | ComapContratosCovidConnectionUpdated_At
  | ComapContratosCovidGroupBy
  | ComponentAditivoAditivos
  | ComponentCalendarCalendario
  | ComponentConcessaoConcessao
  | ComponentContentContent
  | ComponentContratosContratos
  | ComponentDataHoraDataHora
  | ComponentDocumentDoc
  | ComponentEditalEdital
  | ComponentPenalidadePenalidade
  | ComponentServiceServices
  | ComponentSobreAConcessionariaSobreAConcessionaria
  | ComponentTagsTags
  | ComponentTarifasTarifa
  | ComponentTarifasTerminais
  | ComponentTaxaTaxas
  | ComponentTerminaisHidroviariosTerminaisHidroviarios
  | ConsultasPublicas
  | ConsultasPublicasAggregator
  | ConsultasPublicasConnection
  | ConsultasPublicasConnectionComunica
  | ConsultasPublicasConnectionCreated_At
  | ConsultasPublicasConnectionData
  | ConsultasPublicasConnectionEncerramento
  | ConsultasPublicasConnectionId
  | ConsultasPublicasConnectionParticipacao
  | ConsultasPublicasConnectionPublished_At
  | ConsultasPublicasConnectionTitulo
  | ConsultasPublicasConnectionUpdated_At
  | ConsultasPublicasGroupBy
  | CsjriInformeDeJulgamento
  | CsjriInformeDeJulgamentoAggregator
  | CsjriInformeDeJulgamentoConnection
  | CsjriInformeDeJulgamentoConnectionCreated_At
  | CsjriInformeDeJulgamentoConnectionData
  | CsjriInformeDeJulgamentoConnectionDescription
  | CsjriInformeDeJulgamentoConnectionId
  | CsjriInformeDeJulgamentoConnectionPublished_At
  | CsjriInformeDeJulgamentoConnectionTitulo
  | CsjriInformeDeJulgamentoConnectionUpdated_At
  | CsjriInformeDeJulgamentoGroupBy
  | CsjriInformesDeJulgamento
  | DfisLicencasEspeciais
  | DfisVistorias
  | DpseCadastro
  | DtafTarifasDosTerminaisHidroviarios
  | DtafTarifasDosTerminaisHidroviariosAggregator
  | DtafTarifasDosTerminaisHidroviariosAggregatorAvg
  | DtafTarifasDosTerminaisHidroviariosAggregatorMax
  | DtafTarifasDosTerminaisHidroviariosAggregatorMin
  | DtafTarifasDosTerminaisHidroviariosAggregatorSum
  ...
  | DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_I
  | DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_Ii
  | DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_Iii
  | DtafTarifasDosTerminaisHidroviariosConnectionObs_Classe_Iv
  | DtafTarifasDosTerminaisHidroviariosConnectionPublished_At
  | DtafTarifasDosTerminaisHidroviariosConnectionUpdated_At
  | DtafTarifasDosTerminaisHidroviariosGroupBy
  | Gas
  | I18NLocale
  | Licitacoes
  | LicitacoesAggregator
  | LicitacoesConnection
  | LicitacoesConnectionCreated_At
  | LicitacoesConnectionDataHora
  | LicitacoesConnectionDescription
  | LicitacoesConnectionId
  | LicitacoesConnectionLocal
  | LicitacoesConnectionPublished_At
  | LicitacoesConnectionSubTitulo
  | LicitacoesConnectionTipo
  | LicitacoesConnectionTitle
  | LicitacoesConnectionUpdated_At
  | LicitacoesConnectionUrl_Destino
  | LicitacoesGroupBy
  | NgctthTransportesHidroviarios
  | NgctthTransportesHidroviariosAggregator
  | NgctthTransportesHidroviariosConnection
  | NgctthTransportesHidroviariosConnectionContrato
  | NgctthTransportesHidroviariosConnectionCreated_At
  | NgctthTransportesHidroviariosConnectionEmail
  | NgctthTransportesHidroviariosConnectionEmpresa
  | NgctthTransportesHidroviariosConnectionEndereco
  | NgctthTransportesHidroviariosConnectionId
  | NgctthTransportesHidroviariosConnectionPublished_At
  | NgctthTransportesHidroviariosConnectionTelefone
  | NgctthTransportesHidroviariosConnectionTerminal
  | NgctthTransportesHidroviariosConnectionUpdated_At
  | NgctthTransportesHidroviariosGroupBy
  | Noticias
  | NoticiasAggregator
  | NoticiasConnection
  | NoticiasConnectionAlternativo
  | NoticiasConnectionApoio
  | NoticiasConnectionCor_Da_Fonte
  | NoticiasConnectionCreated_At
  | NoticiasConnectionData
  | NoticiasConnectionDestaque
  | NoticiasConnectionFonte_Foto
  | NoticiasConnectionId
  | NoticiasConnectionMateria
  | NoticiasConnectionPublished_At
  | NoticiasConnectionTipo
  | NoticiasConnectionTitulo
  | NoticiasConnectionUpdated_At
  | NoticiasGroupBy
  | NoticiasUrgentes
  | NoticiasUrgentesAggregator
  | NoticiasUrgentesConnection
  | NoticiasUrgentesConnectionCreated_At
  | NoticiasUrgentesConnectionId
  | NoticiasUrgentesConnectionPublished_At
  | NoticiasUrgentesConnectionTitulo
  | NoticiasUrgentesConnectionUpdated_At
  | NoticiasUrgentesConnectionUrl
  | NoticiasUrgentesGroupBy
  | Ouvidoria
  | Paginas
  | PaginasAggregator
  | PaginasConnection
  | PaginasConnectionContent
  | PaginasConnectionCreated_At
  | PaginasConnectionId
  | PaginasConnectionPublished_At
  | PaginasConnectionTitulo
  | PaginasConnectionUpdated_At
  | PaginasConnectionUrl
  | PaginasGroupBy
  | Penalidaddes
  | PenalidaddesAggregator
  | PenalidaddesConnection
  | PenalidaddesConnectionCreated_At
  | PenalidaddesConnectionId
  | PenalidaddesConnectionPublished_At
  | PenalidaddesConnectionTitulo
  | PenalidaddesConnectionUpdated_At
  | PenalidaddesGroupBy
  | Resolucoes
  | ResolucoesAggregator
  | ResolucoesConnection
  | ResolucoesConnectionCreated_At
  | ResolucoesConnectionData
  | ResolucoesConnectionEmenta
  | ResolucoesConnectionId
  | ResolucoesConnectionPublished_At
  | ResolucoesConnectionSub_Tipo_De_Resolucao
  | ResolucoesConnectionTipos_De_Resolucoe
  | ResolucoesConnectionTitulo
  | ResolucoesConnectionUpdated_At
  | ResolucoesGroupBy
  | Rodovias
  | RodoviasAggregator
  | RodoviasConnection
  | RodoviasConnectionCreated_At
  | RodoviasConnectionId
  | RodoviasConnectionNome
  | RodoviasConnectionPublished_At
  | RodoviasConnectionTermo_De_Subrogacao
  | RodoviasConnectionUpdated_At
  | RodoviasGroupBy
  | Servicos
  | ServicosAggregator
  | ServicosConnection
  | ServicosConnectionCreated_At
  | ServicosConnectionId
  | ServicosConnectionPublished_At
  | ServicosConnectionTitle
  | ServicosConnectionTitulo
  | ServicosConnectionUpdated_At
  | ServicosGroupBy
  | SubTipoDeResolucao
  | SubTipoDeResolucaoAggregator
  | SubTipoDeResolucaoConnection
  | SubTipoDeResolucaoConnectionCreated_At
  | SubTipoDeResolucaoConnectionId
  | SubTipoDeResolucaoConnectionPublished_At
  | SubTipoDeResolucaoConnectionSubTipo
  | SubTipoDeResolucaoConnectionUpdated_At
  | SubTipoDeResolucaoGroupBy
  | TarifasDasRodovias
  | TarifasDasRodoviasAggregator
  | TarifasDasRodoviasConnection
  | TarifasDasRodoviasConnectionCreated_At
  | TarifasDasRodoviasConnectionId
  | TarifasDasRodoviasConnectionPublished_At
  | TarifasDasRodoviasConnectionRodovia
  | TarifasDasRodoviasConnectionUpdated_At
  | TarifasDasRodoviasGroupBy
  | TarifasDosTerminaisRodoviarios
  | TarifasDosTerminaisRodoviariosAggregator
  | TarifasDosTerminaisRodoviariosAggregatorAvg
  | TarifasDosTerminaisRodoviariosAggregatorMax
  | TarifasDosTerminaisRodoviariosAggregatorMin
  | TarifasDosTerminaisRodoviariosAggregatorSum
  | TarifasDosTerminaisRodoviariosConnection
  | TarifasDosTerminaisRodoviariosConnectionCreated_At
  | TarifasDosTerminaisRodoviariosConnectionId
  | TarifasDosTerminaisRodoviariosConnectionObs_Classe_I
  | TarifasDosTerminaisRodoviariosConnectionObs_Classe_Ii
  | TarifasDosTerminaisRodoviariosConnectionObs_Classe_Iii
  | TarifasDosTerminaisRodoviariosConnectionObs_Classe_Iv
  | TarifasDosTerminaisRodoviariosConnectionPublished_At
  | TarifasDosTerminaisRodoviariosConnectionUpdated_At
  | TarifasDosTerminaisRodoviariosGroupBy
  | TaxasEValores
  | TaxasEValoresAggregator
  | TaxasEValoresConnection
  | TaxasEValoresConnectionCreated_At
  | TaxasEValoresConnectionId
  | TaxasEValoresConnectionNome
  | TaxasEValoresConnectionPublished_At
  | TaxasEValoresConnectionUpdated_At
  | TaxasEValoresGroupBy
  | TerminaisAeroviarios
  | TerminaisAeroviariosAggregator
  | TerminaisAeroviariosConnection
  | TerminaisAeroviariosConnectionContrato
  | TerminaisAeroviariosConnectionCreated_At
  | TerminaisAeroviariosConnectionEmail
  | TerminaisAeroviariosConnectionId
  | TerminaisAeroviariosConnectionPublished_At
  | TerminaisAeroviariosConnectionTelefone
  | TerminaisAeroviariosConnectionTerminal
  | TerminaisAeroviariosConnectionUpdated_At
  | TerminaisAeroviariosGroupBy
  | TerminaisHidroviarios
  | TerminaisHidroviariosAggregator
  | TerminaisHidroviariosConnection
  | TerminaisHidroviariosConnectionContrato
  | TerminaisHidroviariosConnectionCreated_At
  | TerminaisHidroviariosConnectionEmail
  | TerminaisHidroviariosConnectionId
  | TerminaisHidroviariosConnectionPublished_At
  | TerminaisHidroviariosConnectionTelefone
  | TerminaisHidroviariosConnectionTerminal
  | TerminaisHidroviariosConnectionUpdated_At
  | TerminaisHidroviariosGroupBy
  | TerminaisRodoviarios
  | TerminaisRodoviariosAggregator
  | TerminaisRodoviariosConnection
  | TerminaisRodoviariosConnectionContrato
  | TerminaisRodoviariosConnectionCreated_At
  | TerminaisRodoviariosConnectionEmail
  | TerminaisRodoviariosConnectionId
  | TerminaisRodoviariosConnectionPublished_At
  | TerminaisRodoviariosConnectionTelefone
  | TerminaisRodoviariosConnectionTerminal
  | TerminaisRodoviariosConnectionUpdated_At
  | TerminaisRodoviariosGroupBy
  | Teste
  | TesteAggregator
  | TesteConnection
  | TesteConnectionCreated_At
  | TesteConnectionId
  | TesteConnectionPublished_At
  | TesteConnectionTeste
  | TesteConnectionTestetttt
  | TesteConnectionUpdated_At
  | TesteGroupBy
  | TiposDeResolucoes
  | TiposDeResolucoesAggregator
  | TiposDeResolucoesConnection
  | TiposDeResolucoesConnectionCreated_At
  | TiposDeResolucoesConnectionId
  | TiposDeResolucoesConnectionPublished_At
  | TiposDeResolucoesConnectionTipo
  | TiposDeResolucoesConnectionUpdated_At
  | TiposDeResolucoesGroupBy
  | UploadFile
  ...
  | CreateAscomCartilhaPayload
  | CreateAscomFaqPayload
  | CreateAtasDeColegiadoPayload
  | CreateAtasDeJulgamentoPayload
  | CreateAudienciasPublicaPayload
  | CreateComapContratosCovidPayload
  | CreateConsultasPublicaPayload
  | CreateCsjriInformeDeJulgamentoPayload
  | CreateDtafTarifasDosTerminaisHidroviarioPayload
  | CreateLicitacoePayload
  | CreateNgctthTransportesHidroviarioPayload
  | CreateNoticiaPayload
  | CreateNoticiasUrgentePayload
  | CreatePaginaPayload
  | CreatePenalidaddePayload
  | CreateResolucoePayload
  | CreateRodoviaPayload
  | CreateRolePayload
  | CreateServicoPayload
  | CreateSubTipoDeResolucaoPayload
  | CreateTarifasDasRodoviaPayload
  | CreateTarifasDosTerminaisRodoviarioPayload
  | CreateTaxasEValorePayload
  | CreateTerminaisAeroviarioPayload
  | CreateTerminaisHidroviarioPayload
  | CreateTerminaisRodoviarioPayload
  | CreateTestePayload
  | CreateTiposDeResolucoePayload
  | CreateUserPayload
  | DeleteAscomCartilhaPayload
  | DeleteAscomFaqPayload
  | DeleteAtasDeColegiadoPayload
  | DeleteAtasDeJulgamentoPayload
  | DeleteAudienciasPublicaPayload
  | DeleteComapContratosCovidPayload
  | DeleteConsultasPublicaPayload
  | DeleteCsjriInformeDeJulgamentoPayload
  | DeleteCsjriInformesDeJulgamentoPayload
  | DeleteDfisLicencasEspeciaiPayload
  | DeleteDfisVistoriaPayload
  | DeleteDpseCadastroPayload
  | DeleteDtafTarifasDosTerminaisHidroviarioPayload
  | DeleteFilePayload
  | DeleteGasPayload
  | DeleteLicitacoePayload
  | DeleteNgctthTransportesHidroviarioPayload
  | DeleteNoticiaPayload
  | DeleteNoticiasUrgentePayload
  | DeleteOuvidoriaPayload
  | DeletePaginaPayload
  | DeletePenalidaddePayload
  | DeleteResolucoePayload
  | DeleteRodoviaPayload
  | DeleteRolePayload
  | DeleteServicoPayload
  | DeleteSubTipoDeResolucaoPayload
  | DeleteTarifasDasRodoviaPayload
  | DeleteTarifasDosTerminaisRodoviarioPayload
  | DeleteTaxasEValorePayload
  | DeleteTerminaisAeroviarioPayload
  | DeleteTerminaisHidroviarioPayload
  | DeleteTerminaisRodoviarioPayload
  | DeleteTestePayload
  | DeleteTiposDeResolucoePayload
  | DeleteUserPayload
  | UpdateAscomCartilhaPayload
  | UpdateAscomFaqPayload
  | UpdateAtasDeColegiadoPayload
  | UpdateAtasDeJulgamentoPayload
  | UpdateAudienciasPublicaPayload
  | UpdateComapContratosCovidPayload
  | UpdateConsultasPublicaPayload
  | UpdateCsjriInformeDeJulgamentoPayload
  | UpdateCsjriInformesDeJulgamentoPayload
  | UpdateDfisLicencasEspeciaiPayload
  | UpdateDfisVistoriaPayload
  | UpdateDpseCadastroPayload
  | UpdateDtafTarifasDosTerminaisHidroviarioPayload
  | UpdateGasPayload
  | UpdateLicitacoePayload
  | UpdateNgctthTransportesHidroviarioPayload
  | UpdateNoticiaPayload
  | UpdateNoticiasUrgentePayload
  | UpdateOuvidoriaPayload
  | UpdatePaginaPayload
  | UpdatePenalidaddePayload
  | UpdateResolucoePayload
  | UpdateRodoviaPayload
  | UpdateRolePayload
  | UpdateServicoPayload
  | UpdateSubTipoDeResolucaoPayload
  | UpdateTarifasDasRodoviaPayload
  | UpdateTarifasDosTerminaisRodoviarioPayload
  | UpdateTaxasEValorePayload
  | UpdateTerminaisAeroviarioPayload
  | UpdateTerminaisHidroviarioPayload
  | UpdateTerminaisRodoviarioPayload
  | UpdateTestePayload
  | UpdateTiposDeResolucoePayload
  | UpdateUserPayload
...
export type NgctthTransportesHidroviariosGroupBy = {
  ...
  contrato?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionContrato>>
  >
  created_at?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionCreated_At>>
  >
  ...
  endereco?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionEndereco>>
  >
  id?: Maybe<Array<Maybe<NgctthTransportesHidroviariosConnectionId>>>
  published_at?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionPublished_At>>
  >
  telefone?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionTelefone>>
  >
  terminal?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionTerminal>>
  >
  updated_at?: Maybe<
    Array<Maybe<NgctthTransportesHidroviariosConnectionUpdated_At>>
  >
}
...
export type Query = {
  ...
  dtafTarifasDosTerminaisHidroviarios?: Maybe<
    Array<Maybe<DtafTarifasDosTerminaisHidroviarios>>
  >
  ...
  ngctthTransportesHidroviarios?: Maybe<
    Array<Maybe<NgctthTransportesHidroviarios>>
  >
  ...
  tarifasDosTerminaisRodoviarios?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviarios>>
  >
...
export type ResolucoesGroupBy = {
  ...
  sub_tipo_de_resolucao?: Maybe<
    Array<Maybe<ResolucoesConnectionSub_Tipo_De_Resolucao>>
  >
  tipos_de_resolucoe?: Maybe<
    Array<Maybe<ResolucoesConnectionTipos_De_Resolucoe>>
  >
...
export type RodoviasGroupBy = {
  ...
  termo_de_subrogacao?: Maybe<
    Array<Maybe<RodoviasConnectionTermo_De_Subrogacao>>
  >
...
export type TarifasDosTerminaisRodoviariosGroupBy = {
  ...
  Obs_Classe_I?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionObs_Classe_I>>
  >
  Obs_Classe_II?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionObs_Classe_Ii>>
  >
  Obs_Classe_III?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionObs_Classe_Iii>>
  >
  Obs_Classe_IV?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionObs_Classe_Iv>>
  >
  created_at?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionCreated_At>>
  >
  id?: Maybe<Array<Maybe<TarifasDosTerminaisRodoviariosConnectionId>>>
  published_at?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionPublished_At>>
  >
  updated_at?: Maybe<
    Array<Maybe<TarifasDosTerminaisRodoviariosConnectionUpdated_At>>
  >
}
...
export type TerminaisHidroviariosGroupBy = {
  ...
  published_at?: Maybe<
    Array<Maybe<TerminaisHidroviariosConnectionPublished_At>>
  >
...
export type EditAudienciasPublicaInput = {
  Calendario?: InputMaybe<
    Array<InputMaybe<EditComponentCalendarCalendarioInput>>
  >
  Data?: InputMaybe<Scalars['Date']>
  Titulo?: InputMaybe<Scalars['String']>
  comunica?: InputMaybe<Scalars['String']>
...
export type EditDtafTarifasDosTerminaisHidroviarioInput = {
  ...
  Terminais_Hidroviarios?: InputMaybe<
    Array<
      InputMaybe<EditComponentTerminaisHidroviariosTerminaisHidroviarioInput>
    >
  >
  created_by?: InputMaybe<Scalars['ID']>
  published_at?: InputMaybe<Scalars['DateTime']>
...
export type EditPenalidaddeInput = {
  Titulo?: InputMaybe<Scalars['String']>
  created_by?: InputMaybe<Scalars['ID']>
  penalidade?: InputMaybe<
    Array<InputMaybe<EditComponentPenalidadePenalidadeInput>>
  >
  published_at?: InputMaybe<Scalars['DateTime']>
  updated_by?: InputMaybe<Scalars['ID']>
}
...
export type EditRodoviaInput = {
  Concessao?: InputMaybe<
    Array<InputMaybe<EditComponentConcessaoConcessaoInput>>
  >
...
export type EditTarifasDosTerminaisRodoviarioInput = {
  ...
  created_by?: InputMaybe<Scalars['ID']>
  published_at?: InputMaybe<Scalars['DateTime']>
  terminais_rodoviarios?: InputMaybe<
    Array<InputMaybe<EditComponentTarifasTerminaiInput>>
  >
  updated_by?: InputMaybe<Scalars['ID']>
}
