  ...
  linhas?: {
    ...
    data: Array<{
      ...
      attributes?: {
        ...
        cdlinha?: number | null
        nulinha?: string | null
        deorigem?: string | null
        dedestino?: string | null
        dedescricao?: string | null
        nupermissionarios?: number | null
        boativo?: boolean | null
      } | null
    }>
  } | null
}
 ...
 * });
 */
export function useGetLinhasQuery(
  baseOptions: Apollo.QueryHookOptions<GetLinhasQuery, GetLinhasQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetLinhasQuery, GetLinhasQueryVariables>(
    GetLinhasDocument,
    options,
  )
}
export function useGetLinhasLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetLinhasQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<GetLinhasQuery, GetLinhasQueryVariables>(
    GetLinhasDocument,
    options,
  )
}
export type GetLinhasQueryHookResult = ReturnType<typeof useGetLinhasQuery>
export type GetLinhasLazyQueryHookResult = ReturnType<
  typeof useGetLinhasLazyQuery
>
export type GetLinhasQueryResult = Apollo.QueryResult<
  GetLinhasQuery,
  GetLinhasQueryVariables
>
