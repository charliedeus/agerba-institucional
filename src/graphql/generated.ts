...
export type GenericMorph = Category | City | ComponentArquivosArquivos | ComponentCalendarCalendar | ComponentClassClasses | ComponentDocumentoVigenciaDocumentoVigencia | ComponentEventEvent | ComponentMunicipiosMunicipios | ComponentPerguntasERespostasPAndR | ComponentSectionsToContentSections | ComponentStudentsStudentResources | ComponentTagsTags | ComponentTarifasFerryBoat | ComponentTarifasTarifasTransporteRodoviario | ComponentTarifasTransporteHidroviario | ComponentTarifasTute | Department | EventoPublico | Faq | GasTariff | I18NLocale | JudgmentNote | Legislation | Licitacao | Log | MeetingNote | Noticia | PublicConsultation | QuadroTarifario | RevenueGroup | RevenueService | School | StudentId | Terminal | TerminalsUsageFee | Title | TollRoadTariff | TransportFee | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | WaterwayTransport | WaterwayTransportTariff;
