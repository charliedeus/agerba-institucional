...
export type GenericMorph = Advertisement | Category | City | ComponentArquivosArquivos | ComponentCalendarCalendar | ComponentClassClasses | ComponentDocumentoVigenciaDocumentoVigencia | ComponentEventEvent | ComponentMunicipiosMunicipios | ComponentPerguntasERespostasPAndR | ComponentSectionsToContentSections | ComponentStudentsStudentResources | ComponentTagsTags | ComponentTarifasFerryBoat | ComponentTarifasTarifasTransporteRodoviario | ComponentTarifasTransporteHidroviario | ComponentTarifasTute | Department | EventoPublico | Faq | GasTariff | I18NLocale | JudgmentNote | Legislation | Licitacao | Linha | Log | MeetingNote | Noticia | PublicConsultation | QuadroTarifario | RevenueGroup | RevenueService | School | SearchResult | StudentId | Terminal | TerminalsUsageFee | Title | TollRoadTariff | TransportFee | UploadFile | UploadFolder | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser | WaterwayTransport | WaterwayTransportTariff;
 ...
 *
 * To run a query within a React component, call `useGetLinhasQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLinhasQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLinhasQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *      start: // value for 'start'
 ...
 * });
 */
export function useGetLinhasQuery(baseOptions: Apollo.QueryHookOptions<GetLinhasQuery, GetLinhasQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLinhasQuery, GetLinhasQueryVariables>(GetLinhasDocument, options);
      }
export function useGetLinhasLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLinhasQuery, GetLinhasQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLinhasQuery, GetLinhasQueryVariables>(GetLinhasDocument, options);
        }
export type GetLinhasQueryHookResult = ReturnType<typeof useGetLinhasQuery>;
export type GetLinhasLazyQueryHookResult = ReturnType<typeof useGetLinhasLazyQuery>;
export type GetLinhasQueryResult = Apollo.QueryResult<GetLinhasQuery, GetLinhasQueryVariables>;
 ...
 * });
 */
export function useGetDestaquesQuery(baseOptions?: Apollo.QueryHookOptions<GetDestaquesQuery, GetDestaquesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDestaquesQuery, GetDestaquesQueryVariables>(GetDestaquesDocument, options);
      }
export function useGetDestaquesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDestaquesQuery, GetDestaquesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDestaquesQuery, GetDestaquesQueryVariables>(GetDestaquesDocument, options);
        }
export type GetDestaquesQueryHookResult = ReturnType<typeof useGetDestaquesQuery>;
export type GetDestaquesLazyQueryHookResult = ReturnType<typeof useGetDestaquesLazyQuery>;
export type GetDestaquesQueryResult = Apollo.QueryResult<GetDestaquesQuery, GetDestaquesQueryVariables>;
 ...
 * });
 */
export function useGetPesquisasDeSatisfacaoQuery(baseOptions: Apollo.QueryHookOptions<GetPesquisasDeSatisfacaoQuery, GetPesquisasDeSatisfacaoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPesquisasDeSatisfacaoQuery, GetPesquisasDeSatisfacaoQueryVariables>(GetPesquisasDeSatisfacaoDocument, options);
      }
export function useGetPesquisasDeSatisfacaoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPesquisasDeSatisfacaoQuery, GetPesquisasDeSatisfacaoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPesquisasDeSatisfacaoQuery, GetPesquisasDeSatisfacaoQueryVariables>(GetPesquisasDeSatisfacaoDocument, options);
        }
export type GetPesquisasDeSatisfacaoQueryHookResult = ReturnType<typeof useGetPesquisasDeSatisfacaoQuery>;
export type GetPesquisasDeSatisfacaoLazyQueryHookResult = ReturnType<typeof useGetPesquisasDeSatisfacaoLazyQuery>;
export type GetPesquisasDeSatisfacaoQueryResult = Apollo.QueryResult<GetPesquisasDeSatisfacaoQuery, GetPesquisasDeSatisfacaoQueryVariables>;
