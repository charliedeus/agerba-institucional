    ...
    <article className="flex flex-col gap-6 min-h-[calc(100vh-70px)] desktop:max-w-[1280px] m-auto px-[14px] py-16 text-base leading-relaxed">
      ...
      <div className="flex flex-col gap-6 laptop:flex-row">
        <p>
          ...
          encaminhar e acompanhar sugestões, reclamações, informações, denúncias
          e elogios dos cidadãos referentes aos serviços de transporte
          rodoviário intermunicipal de passageiros de do Estado da Bahia;
          transporte hidroviário intermunicipal de passageiros e de passageiros
          e veículos, através do Sistema Ferry-Boat, dentro e fora da Baía de
          Todos os Santos; distribuição e comercialização de gás canalizado;
          administração de terminais rodoviários, hidroviários e aeroviários de
          passageiros; e a concessão de Rodovias pedagiadas, como a Rodovia BA -
          099 (Sistema Estrada do Coco / Linha Verde) e Sistema Rodoviário BA -
          093.
        </p>
      ...
      <p>
        A participação da sociedade torna-se uma valorosa contribuição na busca
        da prestação do serviço público de forma adequada, priorizando a
      ...
      <div className="flex flex-col laptop:flex-row gap-2 bg-gray-200 px-4 py-6 rounded-lg">
        ...
        <div className="flex flex-col laptop:w-full laptop:flex-row laptop:gap-2 laptop:items-center">
          <span className="font-bold laptop:flex-1 laptop:pl-2">Ouvidoria</span>
